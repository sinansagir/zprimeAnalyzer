...
lumiInTemplates='15000p0'#str(targetlumi/1000).replace('.','p') # 1/fb
plotForPAS = True
...
# 	sigColors = {sigs[0]:rt.kBlack, sigs[1]:rt.kRed,sigs[2]:rt.kOrange,sigs[3]:rt.kBlue,sigs[4]:rt.kGreen+3}
# 	sigLines = {sigs[0]:1, sigs[1]:3,sigs[2]:5,sigs[3]:7,sigs[4]:7}
	massList = [4000,6000,12000]
	sigs = ['ZpM'+str(mass) for mass in massList]
	siglegs = {'ZpM4000':'RSG (4 TeV)', 'ZpM6000':'RSG (6 TeV)','ZpM8000':'RSG (8 TeV)','ZpM10000':'RSG (10 TeV)','ZpM12000':'RSG (12 TeV)'}
	sigColors = {'ZpM4000':rt.kOrange, 'ZpM6000':rt.kRed,'ZpM8000':rt.kBlack,'ZpM10000':rt.kBlue,'ZpM12000':rt.kGreen+3}
	sigLines = {'ZpM4000':1, 'ZpM6000':1,'ZpM8000':1,'ZpM10000':1,'ZpM12000':1}
# massList = range(2000,10000+1,2000)
# sigs = ['ZpW1M'+str(mass) for mass in massList]
# siglegs = {sigs[0]:'Z\' 1% width (2 TeV)', sigs[1]:'Z\' 1% width (4 TeV)',sigs[2]:'Z\' 1% width (6 TeV)',sigs[3]:'Z\' 1% width (8 TeV)',sigs[4]:'Z\' 1% width (10 TeV)'}
# sigColors = {sigs[0]:rt.kBlack, sigs[1]:rt.kRed,sigs[2]:rt.kOrange,sigs[3]:rt.kBlue,sigs[4]:rt.kGreen+3}
# sigLines = {sigs[0]:1, sigs[1]:3,sigs[2]:5,sigs[3]:7,sigs[4]:7}
